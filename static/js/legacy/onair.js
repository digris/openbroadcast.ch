...
var OnAirApp = function () {
    ...
    this.bindings = function () {
        ...
        $(document).on('click', '[data-onair-controls]', function (e) {
            ...
            // TODO: remove this once refactored to new player
            self.bplayer.controls(_c);
    ...
    this.handle_color = function() {
        ...
        if(self.is_onair) {
            ...
            src_img.onload = function(){
                ...
                const _e = new CustomEvent('livecolor:changed', {detail: _c});
                window.dispatchEvent(_e);
