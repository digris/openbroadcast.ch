...
var AchatApp = function () {
    ...
    this.init = function () {
        ...
        self.container = $('#achat_container');
        self.user = window.current_user;

        if(self.debug) {
            console.debug('AchatApp: init', self.user);
        }
        ...
        let grid = document.querySelector('.messages-container');
        self.packery_container = new Packery(grid, {
    ...
    this.bindings = function () {
        ...
        self.messages_container.on('click', 'a.show-full-text', function(e){
            ...
            self.packery_container.reloadItems();
