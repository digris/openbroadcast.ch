...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ScheduledItem.emission_data'
        db.add_column(u'onair_scheduleditem', 'emission_data',
                      self.gf('django.db.models.fields.TextField')(default='{}'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ScheduledItem.emission_data'
        db.delete_column(u'onair_scheduleditem', 'emission_data')
