...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Contact.dob'
        db.delete_column(u'bshop_contact', 'dob')

        # Adding field 'Contact.discount_level'
        db.add_column(u'bshop_contact', 'discount_level',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Contact.dob'
        db.add_column(u'bshop_contact', 'dob',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Contact.discount_level'
        db.delete_column(u'bshop_contact', 'discount_level')
    ...
    models = {
        ...
        u'bshop.contact': {
            ...
            'billing_first_name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'billing_last_name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
