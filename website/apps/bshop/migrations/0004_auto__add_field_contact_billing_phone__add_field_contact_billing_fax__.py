...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contact.billing_phone'
        db.add_column(u'bshop_contact', 'billing_phone',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Contact.billing_fax'
        db.add_column(u'bshop_contact', 'billing_fax',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Contact.shipping_phone'
        db.add_column(u'bshop_contact', 'shipping_phone',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Contact.shipping_fax'
        db.add_column(u'bshop_contact', 'shipping_fax',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contact.billing_phone'
        db.delete_column(u'bshop_contact', 'billing_phone')

        # Deleting field 'Contact.billing_fax'
        db.delete_column(u'bshop_contact', 'billing_fax')

        # Deleting field 'Contact.shipping_phone'
        db.delete_column(u'bshop_contact', 'shipping_phone')

        # Deleting field 'Contact.shipping_fax'
        db.delete_column(u'bshop_contact', 'shipping_fax')
