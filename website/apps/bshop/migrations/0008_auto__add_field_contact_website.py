...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contact.website'
        db.add_column(u'bshop_contact', 'website',
                      self.gf('django.db.models.fields.URLField')(max_length=128, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contact.website'
        db.delete_column(u'bshop_contact', 'website')
