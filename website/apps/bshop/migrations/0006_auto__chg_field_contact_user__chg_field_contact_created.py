...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'bshop_contact', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['authtools.User']))

        # Changing field 'Contact.created'
        db.alter_column(u'bshop_contact', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Contact.user'
        db.alter_column(u'bshop_contact', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(default=None, unique=True, to=orm['authtools.User']))

        # Changing field 'Contact.created'
        db.alter_column(u'bshop_contact', 'created', self.gf('django.db.models.fields.DateTimeField')())
