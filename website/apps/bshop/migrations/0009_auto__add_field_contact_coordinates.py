...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contact.coordinates'
        db.add_column(u'bshop_contact', 'coordinates',
                      self.gf('geoposition.fields.GeopositionField')(max_length=42, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contact.coordinates'
        db.delete_column(u'bshop_contact', 'coordinates')
