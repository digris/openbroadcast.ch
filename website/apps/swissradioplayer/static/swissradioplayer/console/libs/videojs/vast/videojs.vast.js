  ...
  Vast = function (player, settings) {
    ...
    return {
      ...
      setupEvents: function() {
        ...
        player.one('vast-preroll-removed', function() { // xyz: was 'on'
      ...
      preroll: function() {
        ...
        player.one('ended', player.vast.tearDown); // xyz: was 'on'
      ...
      tearDown: function() {
        ...
        //player.trigger('vast-preroll-removed');  // xyz: was commented out
      },
