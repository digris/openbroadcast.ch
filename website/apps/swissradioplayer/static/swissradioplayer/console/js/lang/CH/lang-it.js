...
radioplayer.lang_it = {
	...
	general: {
		...
		reduced_func_anno:		'Il tuo browser non supporta tutte le funzionalità del Radioplayer.' +
								'<a href="http://www.swissradioplayer.ch/cookiehelp/?mob=false" target="_blank">Modifica le impostazioni dei cookie</a>, or <a href="http://www.swissradioplayer.ch/apps" target="_blank">passa alla nostra app.</a>',

	    cookie_anno:            'Il Radioplayer usa cookie per migliorare la tua esperienza d’ascolto.<br />' +
	                            'Per scoprire come, <a href="http://www.swissradioplayer.ch/" target="_blank">clicca qui</a>. ' +
	                            'Se continui, accetti di ricevere tutti i cookie di Radioplayer.',

      cookie_message:          'Queste caratteristiche, insieme ad altre, utilizzano i <a href="http://www.swissradioplayer.ch/cookies" target="_blank">cookies</a>. Se sei d\'accordo, continua l\’ascolto.',
  ...
  cookie_menu_message: 			'Visualizza qui i tuoi preferiti',
	...
	stream_error: {
		unavailable: 			'<h1>The sound of silence</h1>' +
								...
								'<p>Puoi provare ad <a href="https://get.adobe.com/flashplayer/" target=”_blank”>aggiornare Flash Player</a> o a utilizzare un altro browser, ma se il tuo dispositivo non lo supporta, prova a <a href="http://www.swissradioplayer.ch/apps" target=”_blank”>scaricare la nostra app gratuita</a> per smartphone e tablet.</p>',
