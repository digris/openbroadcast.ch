...
radioplayer.lang_fr = {
    ...
    general: {
        ...
        '<a href="http://www.maradio.be/cookies/" target="_blank">Changez les paramètres de vos cookies</a>',

        cookie_anno:            'maRadio.be utilise des cookies pour améliorer l\'expérience.<br />' +
        'Pour découvrir comment, <a href="http://www.maradio.be/cookies/" target="_blank">Cliquez ici</a>. ' +
