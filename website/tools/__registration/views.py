...
class ActivationView(TemplateResponseMixin, FormMixin,
    ...
    def form_valid(self, form):
        ...
        """
        TODO: this is extremly ugly!! refactor somehow
        does login the user after setting a password. the default behaviour else is just stupid!!
        """
        from django.contrib.auth import authenticate
        from django.contrib import auth
        from django.shortcuts import redirect
        user = authenticate(username=self.activated_user.email, password=password)
