...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'shop_order', 'billing_phone',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Order.billing_fax'
        db.add_column(u'shop_order', 'billing_fax',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Order.shipping_phone'
        db.add_column(u'shop_order', 'shipping_phone',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Order.shipping_fax'
        db.add_column(u'shop_order', 'shipping_fax',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Order.billing_fax'
        db.delete_column(u'shop_order', 'billing_fax')

        # Deleting field 'Order.shipping_phone'
        db.delete_column(u'shop_order', 'shipping_phone')

        # Deleting field 'Order.shipping_fax'
        db.delete_column(u'shop_order', 'shipping_fax')
