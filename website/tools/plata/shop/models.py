...
class BillingShippingAddress(models.Model):
    ...
    billing_name = models.CharField(_('name'), max_length=100, blank=True)
    billing_phone = models.CharField(_('phone'), max_length=100, blank=True)
    billing_fax = models.CharField(_('fax'), max_length=100, blank=True)

    billing_address = models.TextField(_('address'), blank=True)
    billing_zip_code = models.CharField(plata.settings.PLATA_ZIP_CODE_LABEL, max_length=50, blank=True)
    ...
    shipping_name = models.CharField(_('name'), max_length=100, blank=True)
    shipping_phone = models.CharField(_('phone'), max_length=100, blank=True)
    shipping_fax = models.CharField(_('fax'), max_length=100, blank=True)

    shipping_address = models.TextField(_('address'), blank=True)
    shipping_zip_code = models.CharField(plata.settings.PLATA_ZIP_CODE_LABEL, max_length=50, blank=True)
