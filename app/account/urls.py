...
urlpatterns = [
    ...
    url(r'^password/recover/$', views.PasswordRecoverView.as_view(), name='password_recover'),
    url(r'^password/reset/done/$', views.PasswordResetDoneView.as_view(), name='password_reset_done'),
    url(r'^password/reset/(?P<token>[\w:-]+)/$', views.PasswordResetView.as_view() ,name='password_reset'),

    # user views
    url(r'^user/(?P<uuid>[\w:-]+)/$', views.UserDetailView.as_view(), name='user-detail'),
