...
##################################################################
REMOTE_BASE_URL = config('REMOTE_BASE_URL', default='https://www.openbroadcast.org').rstrip('/')
...
REMOTE_AUTH_ENDPOINT = config('REMOTE_BASE_URL', default='{}/api/v1/auth/user/'.format(REMOTE_BASE_URL))

#API_BASE_AUTH = {'username': 'remote', 'api_key': 'd65b075c593f27a42c26e65be74c047e5b50d215'}

STREAM_URL = config('STREAM_URL', default='https://www.openbroadcast.org/stream/openbroadcast')
...
LOGGING = {
    ...
    'root': {
        'level': 'WARNING',
        'handlers': LOGGING_ROOT_HALNDLERS,
    },
    'formatters': {
        'verbose': {
