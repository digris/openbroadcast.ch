...
radioplayer.lang_de = {
    ...
    general: {
        ...
        '<a href="http://www.swissradioplayer.ch/cookies/" target="_blank">Ändern Sie die Cookie-Einstellungen</a>, oder <a href="http://www.maradio.be/apps" target="_blank">laden Sie sich unsere kostenlose App.</a>',

        cookie_anno:            'Der Radioplayer verwendet Cookies, um alle Funktionen anbieten zu können.<br />' +
        'Was Cookies sind und wie wir sie verwenden, können Sie <a href="http://www.maradio.be/cookies/" target="_blank">hier nachlesen</a>. ' +
    ...
    stream_error: {
        ...
        '<p>Glücklicherweise gibt es einen anderen Weg, das Programm zu hören: <a href="http://www.maradio.be/apps" target="_blank">Laden Sie sich unsere kostenlose Radioplayer-App</a> auf Ihr Smartphone oder Tablet.</p>',
